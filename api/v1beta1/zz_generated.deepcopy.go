...
func (in *AzureStackHCIMachineSpec) DeepCopyInto(out *AzureStackHCIMachineSpec) {
	*out = *in
	...
	in.CustomSize.DeepCopyInto(&out.CustomSize)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GpuMemoryMappedIORegion) DeepCopyInto(out *GpuMemoryMappedIORegion) {
	*out = *in
	if in.Low != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GpuMemoryMappedIORegion.
func (in *GpuMemoryMappedIORegion) DeepCopy() *GpuMemoryMappedIORegion {
	if in == nil {
		return nil
	}
	out := new(GpuMemoryMappedIORegion)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineCustomSize) DeepCopyInto(out *VirtualMachineCustomSize) {
	*out = *in
	if in.CpuCount != nil {
	...
	if in.Assignment != nil {
		...
		*out = new(GpuAssignment)
		**out = **in
	}
	if in.PartitionSizeMB != nil {
		in, out := &in.PartitionSizeMB, &out.PartitionSizeMB
		*out = new(uint64)
		**out = **in
	}
	if in.GpuName != nil {
	...
	if in.MMIORegion != nil {
		in, out := &in.MMIORegion, &out.MMIORegion
		*out = new(GpuMemoryMappedIORegion)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineCustomSize.
func (in *VirtualMachineCustomSize) DeepCopy() *VirtualMachineCustomSize {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineCustomSize)
	in.DeepCopyInto(out)
	return out
}
