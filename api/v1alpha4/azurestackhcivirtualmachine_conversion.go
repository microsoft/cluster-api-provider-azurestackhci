...
func (src *AzureStackHCIVirtualMachine) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1alpha4_AzureStackHCIVirtualMachine_To_v1beta1_AzureStackHCIVirtualMachine(src, dst, nil)
}
...
func (dst *AzureStackHCIVirtualMachine) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return Convert_v1beta1_AzureStackHCIVirtualMachine_To_v1alpha4_AzureStackHCIVirtualMachine(src, dst, nil)
}
...
func (src *AzureStackHCIVirtualMachineList) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1alpha4_AzureStackHCIVirtualMachineList_To_v1beta1_AzureStackHCIVirtualMachineList(src, dst, nil)
}
...
func (dst *AzureStackHCIVirtualMachineList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return Convert_v1beta1_AzureStackHCIVirtualMachineList_To_v1alpha4_AzureStackHCIVirtualMachineList(src, dst, nil)
}
