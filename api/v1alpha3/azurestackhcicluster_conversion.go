...
func (src *AzureStackHCICluster) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1alpha3_AzureStackHCICluster_To_v1beta1_AzureStackHCICluster(src, dst, nil)
}

func (dst *AzureStackHCICluster) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*infrav1beta1.AzureStackHCICluster)
	return Convert_v1beta1_AzureStackHCICluster_To_v1alpha3_AzureStackHCICluster(src, dst, nil)
}
...
func (src *AzureStackHCIClusterList) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1alpha3_AzureStackHCIClusterList_To_v1beta1_AzureStackHCIClusterList(src, dst, nil)
}
...
func (dst *AzureStackHCIClusterList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return Convert_v1beta1_AzureStackHCIClusterList_To_v1alpha3_AzureStackHCIClusterList(src, dst, nil)
}
