...
export AZURESTACKHCI_WORKER_MACHINE_TYPE="${AZURESTACKHCI_WORKER_MACHINE_TYPE:-Standard_K8S_v1}"
export AZURESTACKHCI_WINDOWS_WORKER_MACHINE_TYPE="${AZURESTACKHCI_WINDOWS_WORKER_MACHINE_TYPE:-Standard_K8S_v1}"
export AZURESTACKHCI_LOAD_BALANCER_MACHINE_TYPE="${AZURESTACKHCI_LOAD_BALANCER_MACHINE_TYPE:-Default}"
export AZURESTACKHCI_LOAD_BALANCER_IMAGE_VERSION="${AZURESTACKHCI_LOAD_BALANCER_IMAGE_VERSION:-Default}"
export AZURESTACKHCI_LOAD_BALANCER_COUNT=${AZURESTACKHCI_LOAD_BALANCER_COUNT:-1}
